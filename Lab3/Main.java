public class Main{
    ...
    public static void main(String[] args){
        ...
        System.out.println("sentences" + text.numSent());
        System.out.println("words " + text.numWords());
        System.out.println("letters " + text.numLetters());
        System.out.println("vocals " + text.numVocals());
        System.out.println("consonants" + text.numCons());

        System.out.println("longest word"); text.longestWord();

        System.out.println("most used words ");text.oftenWords();
    }
}
